...
sudo bitnet --datadir bitnet.db init .bitnet

# Starts the node using the parameters specified.
echo "Starting node..."
sudo bitnet --networkid 210 --config .config --miner.etherbase 0x0000000000000000000000000000000000000000 --http.corsdomain * --graphql.corsdomain *